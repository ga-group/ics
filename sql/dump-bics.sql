...
DB.DBA.XML_SET_NS_DECL('bddc', 'https://api.bloomberg.com/eap/catalogs/bbg/classes/', 1);
DB.DBA.XML_SET_NS_DECL('bics','http://data.ga-group.nl/ics/bics/',1);
...
CREATE DUMP_PROCEDURE(dump_bics,
SPARQL
DEFINE input:storage ""
PREFIX owl: <http://www.w3.org/2002/07/owl#>
SELECT ?s ?p ?o
FROM <http://data.ga-group.nl/ics/bics/>
WHERE {
	?s a ?t ; ?p ?o .
