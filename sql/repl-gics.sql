...
SET u{STAGE} gics-staging;
SET u{DIFFG} gics-diff;

SPARQL CREATE SILENT GRAPH <$u{STAGE}>;
SPARQL CLEAR GRAPH <$u{STAGE}>;

DELETE FROM DB.DBA.LOAD_LIST WHERE ll_file = '/home/freundt/author/ics/gics.ttl.repl';
ld_add('/home/freundt/author/ics/gics.ttl.repl', '$u{STAGE}');
rdf_loader_run();
CHECKPOINT;
