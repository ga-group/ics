...
DB.DBA.XML_SET_NS_DECL('trbc','http://permid.org/ontology/trbc/', 1);
DB.DBA.XML_SET_NS_DECL('ics-trbc','http://data.ga-group.nl/ics/trbc/', 1);
...
CREATE DUMP_PROCEDURE(dump_trbc,
SPARQL
DEFINE input:storage ""
PREFIX owl: <http://www.w3.org/2002/07/owl#>
SELECT ?s ?p ?o
FROM <http://data.ga-group.nl/ics/trbc/>
WHERE {
	?s a ?t ; ?p ?o .
